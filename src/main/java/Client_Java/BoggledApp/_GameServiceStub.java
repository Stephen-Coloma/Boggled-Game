...
/**
* BoggledApp/_GameServiceStub.java .
...
public class _GameServiceStub extends org.omg.CORBA.portable.ObjectImpl implements GameService
{
  ...
  public void submitWord (String word, int pid, int gid) throws InvalidWord
  {
            ...
            try {
                ...
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:BoggledApp/InvalidWord:1.0"))
                    throw InvalidWordHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
                submitWord (word, pid, gid        );
            } finally {
                _releaseReply ($in);
            }
  } // submitWord
  ...
  public boolean roundEvaluationDone (int gid)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("roundEvaluationDone", true);
                $out.write_long (gid);
                $in = _invoke ($out);
                ...
                return roundEvaluationDone (gid        );
            } finally {
                _releaseReply ($in);
            }
  } // roundEvaluationDone
  ...
  private void readObject (java.io.ObjectInputStream s) throws java.io.IOException
  {
     ...
     com.sun.corba.se.impl.orbutil.IORCheckImpl.check(str, "Client_Java.Server_Java.model.implementations.BoggledApp._GameServiceStub");
     String[] args = null;
