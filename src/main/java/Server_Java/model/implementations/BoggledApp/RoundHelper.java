...
abstract public class RoundHelper
{
  ...
  public static Round read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    value.players_roundsWon = StringSequenceHelper.read (istream);
    value.playerAccumulatedPoints = istream.read_long ();
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, Round value)
  {
    ...
    StringSequenceHelper.write (ostream, value.players_roundsWon);
    ostream.write_long (value.playerAccumulatedPoints);
